    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td align="right">
                ...
                <a href="<?=toUrl("/site/admin_tables_delete?id={$table['id']}&name={$name}")?>" onclick="return NoDelete()"><button class="btn btn-danger" >DELETE</button></a>
            </td>
...
<!--            <button class="btn">DELETE</button>-->
    ...
    <div>
        <a href="<?=toUrl("/site/admin_new_page?name={$name}")?>"><button class="btn btn-primary">NEW PAGE</button></a>
    </div>
